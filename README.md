...
The only export of this package is the connector. It is both an `inventory` and `executing` connector. Once you have added this package to your pyproject or requirements.txt, you may do things like `pyinfra @incus/my-instance-name-1 fact server.LinuxName` (you may also omit the container name to run against ALL containers).
